...
BEGIN 
sys.dbms_logrep_imp.instantiate_schema(schema_name=>SYS_CONTEXT('USERENV','CURRENT_SCHEMA'), export_db_name=>'XEPDB1', inst_scn=>'2650679');
COMMIT; 
END; 
/ 
...
ALTER TABLE "TEST"."CURRENCIES_COUNTRIES" ADD CONSTRAINT "CURRENCIES_COUNTRIES_PK" PRIMARY KEY ("CURRENCY_ID", "COUNTRY_ID")
  USING INDEX (CREATE UNIQUE INDEX "TEST"."CURRENCIES_COUNTRIES_PK" ON "TEST"."CURRENCIES_COUNTRIES" ("CURRENCY_ID", "COUNTRY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
ALTER TABLE "TEST"."REGIONS" ADD CONSTRAINT "REGIONS_PK" PRIMARY KEY ("REGION_ID")
  USING INDEX (CREATE UNIQUE INDEX "TEST"."REGIONS_PK" ON "TEST"."REGIONS" ("REGION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
ALTER TABLE "TEST"."CITIES" ADD CONSTRAINT "CITIES_PK" PRIMARY KEY ("CITY_ID")
  USING INDEX (CREATE UNIQUE INDEX "TEST"."CITIES_PK" ON "TEST"."CITIES" ("CITY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
ALTER TABLE "TEST"."COUNTRIES" ADD CONSTRAINT "COUNTRIES_PK" PRIMARY KEY ("COUNTRY_ID")
  USING INDEX (CREATE UNIQUE INDEX "TEST"."COUNTRIES_PK" ON "TEST"."COUNTRIES" ("COUNTRY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
ALTER TABLE "TEST"."CURRENCIES" ADD CONSTRAINT "CURRENCIES_PK" PRIMARY KEY ("CURRENCY_ID")
  USING INDEX (CREATE UNIQUE INDEX "TEST"."CURRENCIES_PK" ON "TEST"."CURRENCIES" ("CURRENCY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
